...
*COPY* OF github.com/gholt/ring back before the major refactors of that
package. This devicering package is for use with
github.com/gholt/msgring and github.com/gholt/store etc. until such time
as I can update it all to work with the new ring ideas.
